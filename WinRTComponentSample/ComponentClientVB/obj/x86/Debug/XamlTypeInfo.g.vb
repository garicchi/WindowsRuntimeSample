...
Namespace Global.ComponentClientVB
    ...
    Partial Public Class App
        ...
        Private _provider As Global.ComponentClientVB.ComponentClientVB_XamlTypeInfo.XamlTypeInfoProvider
        ...
        Public Function GetXamlType(type as Global.System.Type) As Global.Windows.UI.Xaml.Markup.IXamlType Implements Global.Windows.UI.Xaml.Markup.IXamlMetadataProvider.GetXamlType
            If _provider Is Nothing
                _provider = new Global.ComponentClientVB.ComponentClientVB_XamlTypeInfo.XamlTypeInfoProvider()
            End If
...
Namespace Global.ComponentClientVB.ComponentClientVB_XamlTypeInfo
    ...
    Friend Class XamlTypeInfoProvider
        ...
        Private Sub InitTypeTables()
            _typeNameTable(0) = "ComponentClientVB.MainPage"
            _typeNameTable(1) = "Windows.UI.Xaml.Controls.Page"
            _typeNameTable(2) = "Windows.UI.Xaml.Controls.UserControl"
            _typeTable(0) = GetType(Global.ComponentClientVB.MainPage)
        ...
        Private Function Activate_0_MainPage() As Global.System.Object
            Return New Global.ComponentClientVB.MainPage()
        End Function


        Private Function CreateXamlType(ByVal typeIndex As Integer) As Global.Windows.UI.Xaml.Markup.IXamlType
            Dim xamlType As Global.ComponentClientVB.ComponentClientVB_XamlTypeInfo.XamlSystemBaseType = Nothing
            Dim userType As Global.ComponentClientVB.ComponentClientVB_XamlTypeInfo.XamlUserType
            Dim typeName As String = _typeNameTable(typeIndex)
            Dim type As Global.System.Type = _typeTable(typeIndex)

            Select Case typeIndex
            Case 0     ' ComponentClientVB.MainPage
                userType = New Global.ComponentClientVB.ComponentClientVB_XamlTypeInfo.XamlUserType(Me, typeName, type, GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"))
                userType.Activator = AddressOf Activate_0_MainPage
                userType.SetIsLocalType()
                xamlType = userType

            Case 1     ' Windows.UI.Xaml.Controls.Page
                xamlType = New Global.ComponentClientVB.ComponentClientVB_XamlTypeInfo.XamlSystemBaseType(typeName, type)
        ...
        Private Function CreateXamlMember(ByVal longMemberName As String) As XamlMember
            Dim xamlMember As Global.ComponentClientVB.ComponentClientVB_XamlTypeInfo.XamlMember = Nothing
            ' No Local Properties
            Return xamlMember
        End Function
    ...
    Friend Class XamlUserType
        Inherits Global.ComponentClientVB.ComponentClientVB_XamlTypeInfo.XamlSystemBaseType
        Private _provider As Global.ComponentClientVB.ComponentClientVB_XamlTypeInfo.XamlTypeInfoProvider
        ...
        Public Sub New(ByVal provider As Global.ComponentClientVB.ComponentClientVB_XamlTypeInfo.XamlTypeInfoProvider, ByVal fullName As String, ByVal fullType As Global.System.Type, ByVal baseType As Global.Windows.UI.Xaml.Markup.IXamlType)
    ...
    Friend Class XamlMember
        ...
        Public Sub New(ByVal provider As Global.ComponentClientVB.ComponentClientVB_XamlTypeInfo.XamlTypeInfoProvider, ByVal name As String, ByVal typeName As String)
            _name = name
            _typeName = typeName
            _provider = provider
        End Sub
